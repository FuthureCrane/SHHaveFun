...
{
    YKOriginalModel *model = [YKOriginalModel yy_modelWithJSON:[YKOriginalModel getJsonFromFile:@"timeLineData"]];
    *yc = model.yClosePrice;
    return [YKOriginalModel getTimeChartModelArrWithOriginalModel:model];
}
...
/**
 ...
 @return 返回转换后的数组
 */
+ (NSArray <YKTimeChartModel *>*)getTimeChartModelArrWithOriginalModel:(YKOriginalModel *)originalModel
{
